...
/*     */     try {
/*  36 */       Connection con = DriverManager.getConnection(ci.getURl(), ci.getLogin(), ci.getPassword());
/*     */ 
...
/*     */ 
/* 118 */     this.jLabel1.setText("Datos del administrador");
...
/* 157 */         AgregarAdministrador.this.jComboBox1ItemStateChanged(evt);
/*     */       }
/*     */     });
...
/*     */ 
/* 165 */     this.jLabel6.setText("ID administrador   *");
...
/* 185 */         AgregarAdministrador.this.jButton1ActionPerformed(evt);
/*     */       }
/*     */     });
/* 188 */     this.jPanel1.add(this.jButton1, new AbsoluteConstraints(350, 430, -1, -1));
/*     */ 
/* 190 */     this.jLabel15.setIcon(new ImageIcon(super.getClass().getResource("/puntodeventa/admin/images/fondoAA.png")));
/* 191 */     this.jLabel15.setText("jLabel15");
/* 192 */     this.jPanel1.add(this.jLabel15, new AbsoluteConstraints(0, 0, 450, 480));
/*     */ 
/* 194 */     this.jLabel16.setText("jLabel16");
/* 195 */     this.jPanel1.add(this.jLabel16, new AbsoluteConstraints(120, 330, 200, -1));
/*     */ 
/* 197 */     this.jComboBox2.setModel(new DefaultComboBoxModel(new String[0]));
/* 198 */     this.jComboBox2.addItemListener(new ItemListener() {
/*     */       public void itemStateChanged(ItemEvent evt) {
/* 200 */         AgregarAdministrador.this.jComboBox2ItemStateChanged(evt);
/*     */       }
/*     */     });
/* 203 */     this.jPanel1.add(this.jComboBox2, new AbsoluteConstraints(107, 188, -1, -1));
/*     */ 
/* 205 */     GroupLayout layout = new GroupLayout(getContentPane());
/* 206 */     getContentPane().setLayout(layout);
/* 207 */     layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel1, GroupLayout.Alignment.TRAILING, -1, -1, 32767));
/*     */ 
/* 211 */     layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel1, -1, -1, 32767));
/*     */ 
/* 216 */     pack();
/*     */   }
/*     */ 
/*     */   private void jButton1ActionPerformed(ActionEvent evt) {
/* 220 */     conexioninicio ci = new conexioninicio();
/*     */     try {
/* 222 */       Class.forName("org.gjt.mm.mysql.Driver");
/*     */     } catch (ClassNotFoundException ex) {
/* 224 */       Logger.getLogger(AgregarAdministrador.class.getName()).log(Level.SEVERE, null, ex);
/*     */     }
...
/* 240 */           String cadenasql2 = "insert into tienda.admin(idadmon ,curp ,contraseña,fechainicio) values('" + this.idamin.getText() + "','" + this.curp.getText().toUpperCase() + "','" + this.contraseña1.getText() + "'," + "CURRENT_DATE)";
...
/* 260 */         Logger.getLogger(AgregarAdministrador.class.getName()).log(Level.SEVERE, null, ex);
/*     */       }
...
/*     */       public void run()
/*     */       {
/* 286 */         new AgregarAdministrador().setVisible(true);
/*     */       }
/*     */     });
/*     */   }
/*     */ }
 ...
 * Qualified Name:     puntodeventa.admin.PrincipalAdmin.AgregarAdministrador
