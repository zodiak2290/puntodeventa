 ...
 * @author alberto
 */
public class CambiarContraseñaCaj extends javax.swing.JFrame {
static String User;
    /** Creates new form PrincipalCliente */
    public CambiarContraseñaCaj() {
        initComponents();
   
        this.setLocationRelativeTo(null); //Centra la ventana Splash
       
    }
    public void recibirCurp(String Curp)
    {
        User=Curp;
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/puntodeventa/admin/images/FondoCaj.png"))); // NOI18N
...
{ 
    Statement stmts=con1.createStatement();
     String cadenasql2 = "UPDATE tienda.cajero set pass ='" + pass2.getText()+ "'  where curp ='" + User  +"' and pass='"+  pass1.getText() +"'";
    ...
    public  void MostrarPirncipaladmin() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new CambiarContraseñaCaj().setVisible(true);
            }
        });
    }
